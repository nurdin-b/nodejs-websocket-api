...
// // Define the /listluckynumber route for HTML view
...
// Serve index.html for the /listluckynumber route
app.get('/listluckynumber', (req, res) => {
  res.sendFile(path.join(__dirname, 'index.html'));
});

// Define the /api/listluckynumber route for JSON API
app.get('/api/listluckynumber', (req, res) => {
  // Fetch lucky numbers from the database
  db.query('SELECT * FROM tbluckydraw', (err, results) => {
    if (err) {
      console.error('Error fetching lucky numbers:', err);
